@echo off
title Sistema de Gestion WoW Bot (Solo Guild) - NaerZone

echo ==========================================
echo    SISTEMA DE GESTION WOW BOT (SOLO GUILD)
echo ==========================================
echo.
...
echo [INFO] Iniciando el entorno virtual y el bot en modo SOLO GUILD...
...
:: Configurar base de datos para desactivar Taberna y activar Guild
